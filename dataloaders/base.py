"""
Based on https://github.com/lindermanlab/S5/blob/main/s5/dataloaders/base.py
"""
...
class SequenceDataset(DefaultCollateMixin):
    ...
    def __init__(self, _name_, data_dir, **dataset_cfg):
        assert _name_ == self._name_
        self.data_dir = Path(data_dir).absolute() / self._name_
